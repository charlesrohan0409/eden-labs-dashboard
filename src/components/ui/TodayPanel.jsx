 ...
 * section, in one list, ordered by how late it is.
 *
 ...
 */
export default function TodayPanel({ data, onGo, onOpenClient }) {
  const items = buildToday(data, { limit: 8 });
    ...
    <div className="bg-night text-white border border-white/[0.07] rounded-2xl p-5 sm:p-6">
      ...
      {items.length === 0 ? (
        <div className="text-[13px] text-white/50 leading-relaxed">
          No overdue tasks, invoices or posts. Good time to write something, or
